...
// Network credentials
const char* ssid = "Room No-05";
const char* password = "BChougule007";
...
const char* base64Encoding = "Um9vbSBOby0wNTpCQ2hvdWd1bGU";  //; // base64encoding user:pass - "dXNlcjpwYXNz", Room No-05:BChougule007 - "Um9vbSBOby0wNTpCQ2hvdWd1bGU"
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf(base64Encoding)>=0)
            {
              ...
              // Change the background-color and font-size attributes to fit your preferences
              client.println("<style>html { font-family: Helvetica; sans-serif; background-color: #0000FF; margin: 0px auto; text-align: center;}");
